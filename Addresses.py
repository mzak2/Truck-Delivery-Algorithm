...
class Addresses:
    ...
    def get_address(self, address, address_csv):
        with open(address_csv, 'r') as address_info:
    ...
    def total_distance(self, address_1, address_2, distance_csv):
        with open(distance_csv, 'r') as distance_info:
